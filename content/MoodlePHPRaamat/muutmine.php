         ...
         if (isset($_REQUEST["id"])) {
            ...
            if ($kask->fetch()) {
             if (isset($_REQUEST["muutmine"])) {
              ...
              echo "<br />";
              echo "Pilt: ".htmlspecialchars($pilt);
               echo  "<img src='https://eu.cmycubes.com/cdn/shop/articles/sebastien-gabriel--imlv9jlb24-unsplash-1.jpg?v=1741830339&width=1100' alt=''>";
              echo "<br />";
